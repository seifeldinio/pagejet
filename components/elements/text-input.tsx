...
const type: ElementsType = "TextInput";
...
export const TextInputFormElement: FormElement = {
  type,
  construct: (id: string) => ({
    id,
    type,
    ...
    <div className="flex flex-col gap-2 w-full bg-purple100 dark:bg-[#1E1E1E] p-3 border border-[#E6E6E6] dark:border-[#323232] rounded-lg">
      ...
      <Input
        ...
        onBlur={(e) => {
          ...
          // Validate
          const valid = TextInputFormElement.validate(element, e.target.value);
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className="text-xs">
                Displayed below the Text Input.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
